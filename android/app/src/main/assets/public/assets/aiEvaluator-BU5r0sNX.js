import{G as i}from"./index-C0zO250r.js";async function l(t,n){const r=new i({apiKey:t}),a=`You are a strict yet encouraging English Grammar and Fluency Evaluator for Bengali learners practicing the English Master Key (300 Speaking Patterns).
